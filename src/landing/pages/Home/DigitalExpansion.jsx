...
export const DigitalExpansion = () => {
  const parallaxImgRef = useScrollParallax({ speed: 0.04, maxOffset: 20, direction: 'up' });
  ...
  return (
    <section className="digital-expansion-section w-full min-h-[76vh] bg-[#FAF6EE] text-[#1C1D21] relative grid grid-cols-1 lg:grid-cols-[46%_54%] box-border overflow-hidden">
      ...
      <div className="digital-image-col relative w-full h-full min-h-[320px] sm:min-h-[420px] lg:min-h-[76vh] bg-[#EDE5D4] z-[5] overflow-hidden">
        <ScrollReveal variant="fade-right" duration={1050} className="relative w-full h-full overflow-hidden">
          <div ref={parallaxImgRef} className="w-full h-full will-change-transform">
            <img
              src={modelImg}
      ...
      <div className="digital-content-col flex flex-col justify-center p-[clamp(1.8rem,3.8vw,4.2rem)_clamp(1.2rem,4vw,5rem)] box-border relative z-[2]">
        ...
        <ScrollReveal variant="fade-up" delay={60} duration={850} className="flex items-center mb-4">
        ...
        <ScrollReveal variant="fade-up" delay={120} duration={900} className="mb-5">
        ...
        <ScrollReveal variant="fade-up" delay={180} duration={950}>
        ...
        {/* Thin Divider Line */}
        <ScrollReveal variant="fade-up" delay={220} duration={850} className="w-full h-px bg-[#E2D8C6] mb-6" />

        {/* Subheading: STORES ALREADY IN ADVANCED STAGE */}
        <ScrollReveal variant="fade-up" delay={260} duration={900} className="mb-4">
        ...
        {/* Status Pill Banner */}
        <ScrollReveal variant="fade-up" delay={620} duration={950} className="bg-[#EAE0CE] border border-[#B58C36]/25 rounded-lg py-[0.85rem] px-[1.2rem] flex items-center gap-[0.85rem] flex-wrap sm:flex-nowrap">
