  ...
  return (
    <section className="digital-expansion-section w-full min-h-[76vh] bg-[#FAF6EE] text-[#1C1D21] relative grid grid-cols-1 lg:grid-cols-[46%_54%] box-border overflow-hidden">
      ...
      <div className="digital-image-col relative w-full h-full min-h-[320px] sm:min-h-[420px] lg:min-h-[76vh] bg-[#EDE5D4] z-[5]">
        ...
        <div className="digital-floating-card absolute top-[clamp(1.5rem,3vw,3.5rem)] right-3 sm:right-6 lg:right-[-28px] w-[clamp(170px,18vw,230px)] bg-[#0D0E12] rounded-[16px] p-[clamp(0.9rem,1.2vw,1.2rem)_clamp(0.9rem,1.2vw,1.25rem)] shadow-[0_12px_36px_rgba(0,0,0,0.45)] border-2 border-white z-10">
      ...
      <div className="digital-content-col flex flex-col justify-center p-[clamp(1.8rem,3.8vw,4.2rem)_clamp(1.2rem,4vw,5rem)] box-border relative z-[2]">
        ...
        {/* Thin Divider Line */}
        <div className="w-full h-px bg-[#E2D8C6] mb-6" />
        ...
        <div className="digital-stores-grid grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2.5 sm:gap-3 mb-[1.6rem]">
          {storeLocations.map((item, idx) => (
            <div
              key={idx}
              className={`bg-white border border-[#E8DFCF] rounded-[10px] py-4 sm:py-5 px-2 text-center shadow-[0_6px_18px_rgba(181,140,54,0.07),0_2px_6px_rgba(0,0,0,0.03)] transition-all duration-300 ${
        ...
        {/* Status Pill Banner */}
        <div className="bg-[#EAE0CE] border border-[#B58C36]/25 rounded-lg py-[0.85rem] px-[1.2rem] flex items-center gap-[0.85rem] flex-wrap sm:flex-nowrap">
